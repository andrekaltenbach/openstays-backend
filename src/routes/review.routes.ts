...
router.get('/reviews/:reviewId', (req: Request, res: Response, next: NextFunction) => {
...
router.put('/reviews/:reviewId', (req: Request, res: Response, next: NextFunction) => {
  const { reviewId } = req.params;
...
router.delete('/reviews/:reviewId', (req: Request, res: Response, next: NextFunction) => {
  const { reviewId } = req.params;
  prisma.review
